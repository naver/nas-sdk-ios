...
SWIFT_ENUM_FWD_DECL(NSInteger, GFPVastIconType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, GFPVastRemindType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, GFPVastExtensionType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, GFPVastResourceCode)
